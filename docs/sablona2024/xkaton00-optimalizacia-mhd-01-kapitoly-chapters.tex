...
Cestujúci sú uložení ako pole čisel, časov ich príchodu, v jednotliv7ch zast8vkach v atribúte \texttt{waitingPassangersArrivalTimes}.
...
Potrobnejšie informácie o kóde sa nachádzajú v programovej dokumentácii, v prílohe \ref{prilohy_programova_dokumentacia}.
