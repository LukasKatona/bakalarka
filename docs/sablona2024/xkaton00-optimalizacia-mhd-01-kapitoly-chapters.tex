...
\begin{enumerate}
  ...
  \item Aktivujte virtuálne prostredie príkazom \texttt{venv\textbackslash Scripts\textbackslash activate} na Windows alebo \texttt{source venv/bin/activate} na Linuxe.
