...
Algoritmy \ref{algoritmus_nsga2}, \ref{algoritmus_non_dominated_sorting}, \ref{algoritmus_crowding_distance_assignment} a \ref{algoritmus_comparsion_operator} sú prevzaté z článku \cite{996017} a sú upravené pre potreby tejto práce.

\vspace*{\dimexpr 0.5\baselineskip\relax}
\begin{algorithm}[h]
\caption{Inicializácia prvej populácie}
\label{algoritmus_initialization_population}
